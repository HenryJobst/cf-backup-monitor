...
public class MonitoringScheduler {
    ...
    @Scheduled(cron = "${cf-backup-monitor.scheduling.job-check-cron}")
    ...
    @Scheduled(cron = "${cf-backup-monitor.restore-test.cron}")
    ...
    @Scheduled(cron = "${cf-backup-monitor.scheduling.orphan-cleanup-cron}")
